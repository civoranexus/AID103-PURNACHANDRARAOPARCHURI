...
# File: cropguard_backend/settings.py
...
# ============================================
OPENWEATHERMAP_API_KEY = os.environ.get('OPENWEATHERMAP_API_KEY', 'your-api-key')
WEATHERAPI_API_KEY = os.environ.get('WEATHERAPI_API_KEY', 'your-api-key')
